...
# migration Service Constitution

This constitution defines governance rules for the **migration** service within the `northstar` domain.

## Scope

Applies to all repositories within the `northstar/migration` service.
...
Update it to reflect the specific governance needs of the migration service.
