...
# clever Service Constitution

This constitution defines governance rules for the **clever** service within the `bridge` domain.

## Scope

Applies to all repositories within the `bridge/clever` service.
...
Update it to reflect the specific governance needs of the clever service.
