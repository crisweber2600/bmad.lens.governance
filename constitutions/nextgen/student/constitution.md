...
# Student Service Constitution

This constitution defines governance rules for the **Student** service within the `nextgen` domain.

## Scope

Applies to all repositories within the `nextgen/student` service.
...
Update it to reflect the specific governance needs of the Student service.
